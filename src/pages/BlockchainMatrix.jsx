  ...
  return (
    <div className="text-center mx-auto" style={{ maxWidth: '800px' }}>
      ...
      <p className="mb-5 text-2xl" style={{ color: 'var(--subtitle)' }}>
        ...
        <div className="mb-10" style={{ color: 'var(--text)' }}>
            <p>
      ...
      {isExpanded && (
        <div className="mt-5 mx-auto">
          <h2 className="header text-center" style={{ color: 'var(--title)' }}>
            ...
            <br></br>
          <p className="text-left section-header" style={{ color: 'var(--subtitle)', maxWidth: '600px', paddingLeft: '50px' }}>
            It consists of:
          </p>
          <div className="text-left mt-5" style={{ color: 'var(--text)', maxWidth: '600px', paddingLeft: '70px'  }}>
          <div>Electricity</div>
          ...
          <div>Fiat Onboarding / Offboarding Access</div>
            ...
            <p className="mt-10 header text-center" style={{ color: 'var(--subtitle)' }}>
            Each layer demands consideration across various categories, inviting contributions to the Crypto Policy DAO
          </p>
          <br></br>
          <div className="text-left mt-5" style={{ color: 'var(--text)', maxWidth: '600px', paddingLeft: '70px'  }}>
          ...
          <div>Assessment of existing blockchain technology meeting these obligations</div>
            </div>
          <br></br>
          <p className="mt-10 text-center text-4xl" style={{ color: 'var(--title)' }}>
            Blockchain Regulation Matrix
            </p>
          <h3 className="mt-5 mb-5 text-center text-3xl" style={{ color: 'var(--title)' }}>
            ...
            <div className="text-left mb-5">
                ...
                <div className="text-left mb-5">
                            ...
                            <ul className="list-disc pl-12" style={{ color: "var(--subtitle)" }}>
                                ...
                                Government Concerns
                                <ul className="list-disc pl-12" style={{ color: "var(--text)" }}>
                                    <li>Ensuring traceability and transparency of transactions</li>
                                    <li>Preventing illegal activities such as money laundering and fraud</li>
                                    <li>Addressing cross-border transaction challenges and regulatory compliance</li>
                                    <li>An anonymous public ledger inhibits appropriate recordkeeping</li>
                                </ul>
                                </li>
                                <li>
                                Consumer Risks
                                <ul className="list-disc pl-12" style={{ color: "var(--text)" }}>
                                    ...
                                    <li>Privacy concerns related to transaction history being publicly accessible</li>
                                ...
                                Cons to over-regulation
                                <ul className="list-disc pl-12" style={{ color: "var(--text)" }}>
                                    <li>Stifling innovation and experimentation with new transaction models</li>
                                    <li>Restricting financial inclusion by imposing excessive compliance requirements</li>
                                    <li>Hampering the usability and efficiency of blockchain transactions</li>
                                </ul>
                                </li>
                                <li>
                                Cons to lack of regulation
                                <ul className="list-disc pl-12" style={{ color: "var(--text)" }}>
                                    <li>Increased susceptibility to fraudulent or malicious transactions</li>
                                    <li>Difficulty in resolving disputes related to unauthorized or erroneous transactions</li>
                                    <li>Lack of consumer protection and accountability</li>
                                </ul>
                                </li>
                                <li>
                                <h3>Does blockchain technology currently exist to fulfill these obligations, and if so, what is it?</h3>
                                <ul className="list-disc pl-12 mb-5" style={{ color: "var(--text)" }}>
                            ...
                            <ul className="list-disc pl-12" style={{ color: "var(--subtitle)" }}>
                                ...
                                <ul className="list-disc pl-12" style={{ color: "var(--text)" }}>
                                    ...
                                    <li>Data sovereignty and jurisdictional challenges in a decentralized environment</li>
                                    <li>Ensuring compliance with data protection and privacy regulations</li>
                                    <li>Addressing the potential use of blockchain for illegal or illicit data storage</li>
                                </ul>
                                </li>
                                <li>
                                Consumer Risks
                                <ul className="list-disc pl-12" style={{ color: "var(--text)" }}>
                                    <li>Exposure of sensitive or personal data to public scrutiny</li>
                                    <li>Risk of data loss or corruption due to the immutability of blockchain</li>
                                    <li>Challenges in managing data access and permissions in a decentralized system</li>
                                </ul>
                                </li>
                                <li>
                                Cons to over-regulation
                                <ul className="list-disc pl-12" style={{ color: "var(--text)" }}>
                                    <li>Impeding the adoption of blockchain for legitimate and innovative data storage use cases</li>
                                    <li>Limiting the potential of decentralized applications (dApps) requiring data storage</li>
                                    <li>Inhibiting data interoperability and portability across different blockchain networks</li>
                                </ul>
                                </li>
                                <li>
                                Cons to lack of regulation
                                <ul className="list-disc pl-12" style={{ color: "var(--text)" }}>
                                    <li>Lack of standardized data storage practices leading to security vulnerabilities</li>
                                    <li>Difficulty in addressing disputes related to ownership and control of stored data</li>
                                    <li>Potential misuse of blockchain for storing illegal or harmful content</li>
                                </ul>
                                </li>
                                <li>Does blockchain technology currently exist to fulfill these obligations, and if so, what is it?
                                <ul className="list-disc pl-12 mb-5" style={{ color: "var(--text)" }}>
                            ...
                            <div className="text-left mb-5">
                                ...
                                <ul className="list-disc pl-12" style={{ color: "var(--subtitle)" }}>
                                    ...
                                    <ul className="list-disc pl-12" style={{ color: "var(--text)" }}>
                                        ...
                                        Government Concerns
                                        <ul className="list-disc pl-12" style={{ color: "var(--text)" }}>
                                            <li>Ensuring stability and value preservation of stablecoins</li>
                                            <li>Preventing money laundering and illegal transactions</li>
                                            <li>Are stablecoins defined correctly in programming terms</li>
                                            <li>The effects of internal inflation based on the unlimited burning / minting mechanisms of popular stables</li>
                                            <li>Addressing potential systemic risks from widespread stablecoin adoption</li>
                                            <li>Does crypto transaction provenance equally replace not having serial numbers on gov&apos;t released stablecoins?</li>
                                        </ul>
                                        </li>
                                        <li>
                                        Consumer Risks
                                        <ul className="list-disc pl-12" style={{ color: "var(--text)" }}>
                                            <li>Risk of stablecoin issuer insolvency or mismanagement</li>
                                            <li>Lack of transparency in stablecoin reserves and collateral</li>
                                            <li>Potential loss of value due to changes in underlying collateral</li>
                                        ...
                                        Cons to over-regulation
                                        <ul className="list-disc pl-12" style={{ color: "var(--text)" }}>
                                            <li>Hindering the growth and innovation of stablecoin use cases</li>
                                            <li>Restricting accessibility and availability of stablecoin services</li>
                                            <li>Imposing barriers for startups and new entrants in the stablecoin market</li>
                                        </ul>
                                        </li>
                                        <li>
                                        Cons to lack of regulation
                                        <ul className="list-disc pl-12" style={{ color: "var(--text)" }}>
                                            <li>Lack of consumer protection and accountability in stablecoin issuance</li>
                                            <li>Vulnerability to financial crises or market manipulation</li>
                                            <li>Difficulty in addressing cross-border regulatory challenges</li>
                                        </ul>
                                        </li>
                                        <li>
                                        Does blockchain technology currently exist to fulfill these obligations, and if so, what is it?
                                ...
                                <ul className="list-disc pl-12" style={{ color: "var(--subtitle)" }}>
                                    ...
                                    <ul className="list-disc pl-12" style={{ color: "var(--text)" }}>
                                        ...
                                        Government Concerns
                                        <ul className="list-disc pl-12" style={{ color: "var(--text)" }}>
                                                <li>Mutability presents a scenario of being &quot;derived from the efforts of others&quot; which leans towards being a security.</li>
                                                <li>Protecting consumers from fraudulent or misleading token offerings.</li>
                                        </ul>
                                        </li>
                                        <li>
                                        Consumer Risks
                                        <ul className="list-disc pl-12" style={{ color: "var(--text)" }}>
                                        <li>Security of transactions: Ensuring that transactions involving fungible tokens are secure, protecting users from hacking, theft, or unauthorized access to their tokens.</li>
                                                    <li>Centralization risks affecting token liquidity, market stability, and control.</li>
                                        </ul>
                                        </li>
                                        <li>
                                        Cons to over-regulation
                                        <ul className="list-disc pl-12" style={{ color: "var(--text)" }}>
                                        <li>Overly stringent regulations could stifle innovation in fungible token use cases and hinder the growth of blockchain projects and applications.</li>
                                                    <li>Excessive regulation might discourage token issuers and developers from exploring new models and tokenization methods.</li>
                                        </ul>
                                        </li>
                                        <li>
                                        Cons to lack of regulation
                                        <ul className="list-disc pl-12" style={{ color: "var(--text)" }}>
                                        <li>Lack of regulatory oversight could lead to fraudulent or misleading token offerings, potentially resulting in financial losses for investors.</li>
                                                    <li>Absence of clear regulations might deter legitimate projects from entering the market due to uncertainties surrounding legal compliance.</li>
                                        </ul>
                                        </li>
                                        <li>
                                        Does blockchain technology currently exist to fulfill these obligations, and if so, what is it?
                                ...
                                <ul className="list-disc pl-12" style={{ color: "var(--subtitle)" }}>
                                    ...
                                    <ul className="list-disc pl-12" style={{ color: "var(--text)" }}>
                                        ...
                                        Government Concerns
                                        <ul className="list-disc pl-12" style={{ color: "var(--text)" }}>
                                        <li>classNameification uncertainty for diverse NFT assets like property records, medical records, or even voting mechanisms</li>
                                                    <li>Data privacy of sensitive NFT content</li>
                                                    <li>Not registering with FinCen or the SEC if selling securities</li>
                                        ...
                                        Consumer Risks
                                        <ul className="list-disc pl-12" style={{ color: "var(--text)" }}>
                                        <li>Data exposure in NFTs, even with restricted access</li>
                                                    <li>Ownership disputes over real-world asset NFTs</li>
                                                    <li>Limited access to tokens due to over-regulation</li>
                                                    <li>Inability to create securities in a regulated environment</li>
                                        </ul>
                                        </li>
                                        <li>
                                        Cons to over-regulation
                                        ...
                                        <li>Stifled innovation due to heavy regulations</li>
                                                    <li>Barrier to entry for startups due to compliance costs</li>
                                                    <li>Lack of security standards and risk management standards</li>
                                                    <li>Limited consumer protection from upgradable features</li>
                                        </ul>
                                        </li>
                                        <li>
                                        Cons to lack of regulation
                            ...
                            <ul className="list-disc pl-12" style={{ color: "var(--subtitle)" }}>
                                ...
                                Government Concerns
                                <ul className="list-disc pl-12" style={{ color: "var(--text)" }}>
                                <li>Not registering with FinCen or the SEC if facilitating securities trading</li>
                <li>Potential facilitation of money laundering on the platform</li>
                                </ul>
                                </li>
                                <li>
                                Consumer Risks
                ...
                <li>Limited access to certain tokens due to regulatory restrictions</li>
                <li>Lack of traditional customer support and dispute resolution</li>
                <li>Interoperability challenges within the decentralized finance (DeFi) ecosystem</li>
                                </ul>
                                </li>
                                <li>
                                Cons to over-regulation
                                <ul className="list-disc pl-12" style={{ color: "var(--text)" }}>
                                <li>Overbearing regulations stifling innovation in decentralized exchanges</li>
                <li>Regulatory hurdles limiting access to tokenized assets</li>
                <li>Difficulty in complying with complex and varying global regulations</li>
                                </ul>
                                </li>
                                <li>
                                Cons to lack of regulation
                                <ul className="list-disc pl-12" style={{ color: "var(--text)" }}>
                                <li>Lack of investor protection and avenues for dispute resolution</li>
                <li>Potential for scams and fraudulent projects on unregulated platforms</li>
                <li>Difficulty in establishing trust without clear regulatory standards</li>
                <li>Absence of standardized security practices and risk mitigation</li>
                                </ul>
                                </li>
                                <li>Does blockchain technology currently exist to fulfill these obligations, and if so, what is it?
                                <ul className="list-disc pl-12 mb-5" style={{ color: "var(--text)" }}>
                            ...
                            <ul className="list-disc pl-12" style={{ color: "var(--subtitle)" }}>
                                ...
                                Gov&apos;t Concerns
                                <ul className="list-disc pl-12" style={{ color: "var(--text)" }}>
                                    <li>Lack of accountability in centralized applications (cApps)</li>
                                    <li>Operating without formal business registration and oversight</li>
                                    <li>Potential limited fiduciary liability for actions taken on cApps</li>
                                </ul>
                                </li>
                                <li>
                                Consumer Risks
                                <ul className="list-disc pl-12" style={{ color: "var(--text)" }}>
                                    <li>Data privacy concerns due to centralized control over user information</li>
                                    <li>Vulnerability to data breaches and security incidents</li>
                                    <li>Dependence on the cApp operator&apos;s security and practices</li>
                                    <li>Limited recourse in case of disputes or malfunctions</li>
                                </ul>
                                </li>
                                <li>
                                Cons to over-regulation
                                <ul className="list-disc pl-12" style={{ color: "var(--text)" }}>
                                    <li>Stifling innovation and growth of centralized cApp ecosystem</li>
                                    <li>Higher entry barriers for startups and new entrants</li>
                                    <li>Potential reduction in user accessibility and choice</li>
                                </ul>
                                </li>
                                <li>
                                Cons to lack of regulation
                                <ul className="list-disc pl-12" style={{ color: "var(--text)" }}>
                                    <li>Lack of standardized security and data protection practices</li>
                                    <li>Potential for unscrupulous behavior and fraudulent activities</li>
                                    <li>Limited avenues for consumer protection and dispute resolution</li>
                                </ul>
                                </li>
                                <li>
                            ...
                            <ul className="list-disc pl-12" style={{ color: "var(--subtitle)" }}>
                                ...
                                <ul className="list-disc pl-12" style={{ color: "var(--text)" }}>
                                    ...
                                    <li>Ensuring the protection of user assets from cross-protocol vulnerabilities and exploits</li>
                                    <li>Ensuring that a protocol can&apos;t be misused because of a DeFi stack interoperability issue</li>
                                    <li>Preventing the use of DeFi platforms for money laundering and illicit activities</li>
                                </ul>
                                </li>
                                <li>
                                Consumer Risks
                                <ul className="list-disc pl-12" style={{ color: "var(--text)" }}>
                                    <li>Exposure to smart contract vulnerabilities leading to asset losses</li>
                                    <li>Risk of funds being locked or inaccessible due to unforeseen circumstances</li>
                                    <li>Dependence on the platform&apos;s security measures and risk management</li>
                                    <li>Lack of understanding of complex DeFi protocols and potential pitfalls</li>
                                    <li>Limited recourse in case of platform hacks or security incidents</li>
                                </ul>
                                </li>
                                <li>
                                Cons to over-regulation
                                <ul className="list-disc pl-12" style={{ color: "var(--text)" }}>
                                    <li>Excessive regulations stifling innovation and hindering DeFi development</li>
                                    <li>Higher compliance costs limiting the accessibility of DeFi products</li>
                                    <li>Slowing down the introduction of new features and functionalities</li>
                                    <li>Potential displacement of development activities to more permissive jurisdictions</li>
                                </ul>
                                </li>
                                <li>
                                Cons to lack of regulation
                                <ul className="list-disc pl-12" style={{ color: "var(--text)" }}>
                                    <li>Proliferation of insecure DeFi platforms and protocols</li>
                                    <li>Lack of standardized security practices leading to increased risks</li>
                                    <li>Difficulty in addressing disputes and liabilities arising from vulnerabilities</li>
                                    <li>Undermining public trust and confidence in DeFi due to frequent security incidents</li>
                                </ul>
                                </li>
                            </ul>
                            </div>
                            ...
                            <ul className="list-disc pl-12" style={{ color: "var(--subtitle)" }}>
                                ...
                                Gov&apos;t Concerns
                                <ul className="list-disc pl-12" style={{ color: "var(--text)" }}>
                                    <li>Ensuring regulatory compliance and consumer protection in the absence of standardized credentials or education requirements</li>
                                    <li>Mitigating risks of financial fraud and money laundering without established industry standards</li>
                                    <li>Monitoring systemic risks within the DeFi ecosystem due to the lack of uniform auditing procedures</li>
                                    <li>Addressing potential disruptions in DeFi operations amidst evolving technological landscape and novel risks</li>
                                    <li>Differentiating between Product Liability, Professional Liability, negligence, and true bugs</li>
                                </ul>
                                </li>
                                <li>
                                Consumer Risks
                                <ul className="list-disc pl-12" style={{ color: "var(--text)" }}>
                                    <li>Exposure to unaudited DeFi protocols leading to financial losses</li>
                                ...
                                <ul className="list-disc pl-12" style={{ color: "var(--text)" }}>
                                    ...
                                    <li>Potential migration of projects to more permissive jurisdictions</li>
                                </ul>
                                </li>
                                <li>
                                Cons to lack of regulation
                                <ul className="list-disc pl-12" style={{ color: "var(--text)" }}>
                                    ...
                                    <li>Vulnerability to fraudulent schemes targeting users</li>
                            ...
                            <ul className="list-disc pl-12" style={{ color: "var(--subtitle)" }}>
                                ...
                                Gov&apos;t Concerns
                                <ul className="list-disc pl-12" style={{ color: "var(--text)" }}>
                                    <li>Ensuring compliance with anti-money laundering (AML) and know-your-customer (KYC) regulations</li>
                                    <li>Monitoring cross-border transactions and preventing potential illicit activities</li>
                                    <li>Addressing tax implications and reporting requirements for fiat-to-crypto conversions</li>
                                    <li>Preventing fraud and ensuring the legitimacy of fiat onboarding/offboarding services</li>
                                </ul>
                                </li>
                                <li>
                                Consumer Risks
                                <ul className="list-disc pl-12" style={{ color: "var(--text)" }}>
                                    <li>Exposure to potential legal consequences for non-compliant or anonymous transactions</li>
                                    <li>Risks associated with offloading blockchain assets to fiat without proper documentation</li>
                                    <li>Lack of investor protections and due diligence when converting assets to fiat</li>
                                    <li>Potential vulnerability to scams or fraudulent intermediaries operating in the fiat-crypto space</li>
                                </ul>
                                </li>
                                <li>
                                Cons to over-regulation
                                <ul className="list-disc pl-12" style={{ color: "var(--text)" }}>
                                    <li>Imposing high compliance costs and barriers for new entrants</li>
                                    <li>Slowing down the development of user-friendly and efficient fiat onboarding/offboarding solutions</li>
                                    <li>Potential hindrance to financial inclusion due to stringent regulations</li>
                                </ul>
                                </li>
                                <li>
                                Cons to lack of regulation
                                <ul className="list-disc pl-12" style={{ color: "var(--text)" }}>
                                    <li>Lack of standardized security and quality practices in fiat-crypto intermediaries</li>
                                    <li>Vulnerability to fraudulent schemes targeting users seeking fiat access</li>
                                    <li>Difficulty in addressing cross-border disputes and regulatory challenges</li>
                                    <li>Potential exposure to money laundering and other illicit activities</li>
