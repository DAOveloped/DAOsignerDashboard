      ...
      <h1 className="mb-5 mt-10 text-center text-5xl" style={{ color: 'var(--title)' }}>
        ...
        <ul className="list-disc pl-12" style={{ color: "var(--subtitle)" }}>
            ...
            <div className="section-col">
                <div className="section">
                    <div className="section-in">
                    <img src="block.jpg" alt="Logo" style={{ display: 'block', width: '200px', height: 'auto', margin: '0 auto' }} />
                    </div>
                </div>
               ...
               <div className="section-col">
				<div className="section">
					<div className="section-in">
                    <img src="blob.jpg" alt="Logo" style={{ display: 'block', width: '200px', height: 'auto', margin: '0 auto' }} />
					</div>
				</div>
			</div>
			<div className="hover-text">
